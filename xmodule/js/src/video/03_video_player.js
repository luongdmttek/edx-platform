        ...
        function(HTML5Video, HTML5HLSVideo, Resizer, HLS, _, Time) {
            ...
            function _initialize(state) {
                ...
                var youTubeId,
                    ...
                    userAgent,
                    commonPlayerConfig,
                    eventToBeTriggered = /Android/i.test(isTouchDevice[0]) ? 'loadedmetadata' : 'canplay';
            ...
            function destroy() {
                ...
                if (player && player.video) {
                    player.video.removeEventListener('canplay', this.videoPlayer.onLoadMetadataHtml5, false);
                    player.video.removeEventListener(/Android/i.test(isTouchDevice[0]) ? 'loadedmetadata' : 'canplay', this.videoPlayer.onLoadMetadataHtml5, false);
                }
